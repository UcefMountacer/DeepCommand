...
get your features and put them in Train_data list
create csv
...
Train_Data = [['max_stft','min_stft','std_stft','amp_stft','mean_stft',
              ...
              'max_z_crossing','min_z_crossing','std_z_crossing','amp_z_crossing','mean_z_crossing','label']]

with open('C:/Users/Mountassir Youssef/Desktop/PJE/Data/classification_super_bruit.csv', 'w') as csvFile:
